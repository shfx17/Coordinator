Public Class Form1
    ...
    Private Sub Form1_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        ...
        txtChat.Text = ":: SERVER #1 STARTED ::" & vbCrLf
    ...
    Private Sub UpdateText(TB As TextBox, txt As String)
        ...
        Else
            ...
            Try
                ...
                If txt = 1 Then
                    TB.AppendText("Artur" & vbCrLf)
                End If

                If txt = 2 Then
                    TB.AppendText("Krzysiu" & vbCrLf)
                End If

                If txt = 3 Then
                    TB.AppendText("Adrian" & vbCrLf)
                End If

                If txt = 4 Then
                    TB.AppendText("Aleksandra" & vbCrLf)
                End If
                ...
                If txt = 133171 Then
                    Client = New TCPController("127.0.0.1", 13317)
                    Try
                        If Client.Client.Connected Then
                            If Client.Client.Connected = True Then
                                Client.Send(1)
